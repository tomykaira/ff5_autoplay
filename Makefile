...
CPPFLAGS=-g -std=c++0x -Wall -I/usr/include/dbus-1.0/ -I/usr/lib/i386-linux-gnu/dbus-1.0/include/

PROG=capture
SRC=capture.cpp number.cpp dbus_client.cpp xlib_ext.cpp recognition.cpp time_util.cpp dungeon.cpp
